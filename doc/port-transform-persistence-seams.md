...
| `OrderPersistencePort` | `RetailOrderPersistenceAdapter` → `OrderLoader.exec` | Add `CoreOrderPersistenceAdapter` and switch CDI default when parity is proven (see `doc/regression-suite-OCOrder.md`). |
