...
public class OrderModel extends Model {
  ...
  public JSONArray getReceiptLines(String orderId) throws JSONException {
    ...
    String sqlLines = "SELECT "
        ...
        + "ol.linegrossamt as \"lineGrossAmount\", "
        + "ol.c_tax_id as \"tax\", "
        + "t.name as \"tax$_identifier\", "
        + "t.rate as \"taxRate\", "
        ...
        + "rr.name as \"returnReason$_identifier\", "
        + "ol.c_order_discount_id as \"orderDiscount\", "
        + "ol.discount as \"discount\", "
        + "(SELECT COALESCE(ol.em_obrdm_deliverymode, 'PickAndCarry')) as \"deliveryMode\", "
        + "ol.em_obrdm_deliverydate as \"deliveryDate\" "
        + "FROM c_orderline ol "
  ...
  private JSONArray getLinePromotions(String lineId) throws JSONException {
    ...
    String sqlPromotions = "SELECT "
        ...
        + "o.name as \"name\", "
        + "o.printname as \"printName\", "
        + "o.em_obdisc_discount_type_id as \"discountType\", "
        + "olo.totalamt as \"amt\", "
        + "olo.totalamt as \"actualAmt\", "
        + "olo.displayedtotalamt as \"displayedTotalAmount\", "
        + "olo.em_obdisc_qtyoffer as \"qtyOffer\", "
        + "olo.em_obdisc_identifier as \"identifier\", "
        + "olo.line as \"lineNo\" "
  ...
  public JSONArray getReceiptPayments(String orderId) throws JSONException {
    ...
    String sqlPayments = "SELECT "
        ...
        + "fp.em_obpos_appCashup as \"cashup\", "
        + "fp.em_obpos_posterminal_id as \"posTerminal\", "
        + "pos.value as \"posTerminalSearchKey\", "
        + "fp.description as \"comment\", "
        + "fp.em_obpos_paymentdata as \"paymentData\", "
        + "fp.reversed_payment_id as \"reversedPaymentId\" "
        + "FROM fin_payment fp "
        ...
        + "pm.fin_paymentmethod_id, c.iso_code, fp.em_obpos_appCashup, "
